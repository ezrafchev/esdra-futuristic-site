...
export default function Home() {
  ...
  const messageYMotion = useTransform([scrollLift, cursorDriftY], ([scroll, cursor]) => scroll + cursor * 0.35)
  const visualYMotion = useTransform([scrollDepth, cursorDriftY], ([scroll, cursor]) => scroll + cursor * 0.6)
  const proofYMotion = useTransform([scrollLift, cursorDriftY], ([scroll, cursor]) => scroll * 0.45 + cursor * 0.2)
