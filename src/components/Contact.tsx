  ...
  return (
    <section id="contact" className="section-shell pb-24">
      ...
      >
        ...
        <h2 className="title-headline mt-4">Vamos tirar seu projeto do papel com padrão premium.</h2>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <a href="mailto:contato@esdrafelipe.dev" className="btn-primary">
            contato@esdrafelipe.dev
          </a>
          <a href="https://wa.me/5531999999999" className="btn-secondary">
            WhatsApp
          </a>
        </div>
      </motion.div>
